...
replacements <- add_row(replacements, old = "Juniperus communis subsp. alpina", new = "Juniperus communis var. saxatilis")
replacements <- add_row(replacements, old = "Salix serpillifolia", new = "Salix serpyllifolia")
replacements <- add_row(replacements, old = "Alnus viridis", new = "Alnus alnobetula subsp. alnobetula")
replacements <- add_row(replacements, old = "Nigritella rhellicani", new = "Gymnadenia rhellicani")
replacements <- add_row(replacements, old = "Loiseleuria procumbens", new = "Kalmia procumbens")
replacements <- add_row(replacements, old = "Tephroseris capitata", new = "Tephroseris integrifolia subsp. capitata")
replacements <- add_row(replacements, old = "Androsace chamaejasme", new = "Androsace villosa subsp. villosa")
replacements <- add_row(replacements, old = "Centaurea montana", new = "Cyanus montanus")
replacements <- add_row(replacements, old = "Chenopodium bonus-henricus", new = "Blitum bonus-henricus")
replacements <- add_row(replacements, old = "Thesium linophyllon", new = "Thesium arvense")
replacements <- add_row(replacements, old = "Crocus albiflorus", new = "Crocus vernus")
...
inexistent <- c("Potentilla verna / pusilla", "Capsella bursa-pastoris", "Molinia arundinacea", "Itea virginica L.", "Caryophyllaceae sp", "Populus ×canescens", "Amaranthaceae sp", "Einjährig", "Flache lange blätter", "Poaceae", "Caryophyllaceae", "A10", "Asteraceae", "Pflanze", "Keimling 1", "Keimling 2", "Runde blätter", "Sedum montanum", "Lamiaceae", "Apiaceae", "Amelanchier humilis", "Pulmonaria australis / mollis", "Gehölz unbekannt", "Rubus fruticosus aggr. s.l.", "Alchemilla alpina aggr. s.l.", "Eudicot sp", "Viola reichenbachiana / riviniana", "Alchemilla vulgaris aggr. s.l.", "Peucedanum austriacum susp. austriacum", "Apiaceae sp")
...
replacements <- add_row(replacements, old = "Plantago serpentina aggr.", new = "Plantago serpentina")
replacements <- add_row(replacements, old = "Pulmonaria mollis aggr.", new = "Pulmonaria mollis")
...
replacements <- add_row(replacements, old = "Peucedanum austriacum susp. austriacum", new = "Peucedanum austriacum")

# Synonyms
replacements <- add_row(replacements, old = "Juniperus communis subsp. alpina", new = "Juniperus nana")
replacements <- add_row(replacements, old = "Ranunculus tuberosus", new = "Ranunculus nemorosus")
...
inexistent <- append(inexistent, "Potentilla verna / pusilla")
inexistent <- append(inexistent, "Rubus fruticosus aggr. s.l.")
inexistent <- append(inexistent, "Viola reichenbachiana / riviniana")
inexistent <- append(inexistent, "Pulmonaria australis / mollis")
inexistent <- append(inexistent, "Alchemilla vulgaris aggr. s.l.")
inexistent <- append(inexistent, "Alchemilla alpina aggr. s.l.")
inexistent <- append(inexistent, "Gehölz unbekannt")
...
replacements <- add_row(replacements, old = "Dryopteris carthusiana", new = "Dryopteris carthusiana aggr.")
...
replacements <- add_row(replacements, old = "Muscari comosum", new = "Leopoldia comosa")
replacements <- add_row(replacements, old = "Hieracium intybaceum", new = "Schlagintweitia intybacea")
replacements <- add_row(replacements, old = "Tephroseris capitata", new = "Tephroseris integrifolia")
replacements <- add_row(replacements, old = "Crocus albiflorus", new = "Crocus vernus")
replacements <- add_row(replacements, old = "Festuca pulchella", new = "Leucopoa pulchella")
replacements <- add_row(replacements, old = "Draba muralis", new = "Drabella muralis")
replacements <- add_row(replacements, old = "Poa variegata", new = "Bellardiochloa variegata")
replacements <- add_row(replacements, old = "Chenopodium bonus-henricus", new = "Blitum bonus-henricus")
replacements <- add_row(replacements, old = "Juniperus communis subsp. alpina", new = "Juniperus communis subsp. nana")
replacements <- add_row(replacements, old = "Centaurea montana", new = "Cyanus montanus")
...
inexistent <- append(inexistent, "Alchemilla alpina aggr. s.l.")
inexistent <- append(inexistent, "Gehölz unbekannt")
inexistent <- append(inexistent, "Senecio ovatus")
inexistent <- append(inexistent, "Luzula sudetica")
inexistent <- append(inexistent, "Dryopteris dilatata")
inexistent <- append(inexistent, "Potentilla verna / pusilla")
inexistent <- append(inexistent, "Pulmonaria australis / mollis")
inexistent <- append(inexistent, "Ranunculus tuberosus")
inexistent <- append(inexistent, "Plantago serpentina aggr.")
...
replacements <- add_row(replacements, old = "Juniperus communis subsp. alpina", new = "Juniperus communis subsp. nana")
replacements <- add_row(replacements, old = "Centaurea montana", new = "Cyanus montanus")
replacements <- add_row(replacements, old = "Ranunculus tuberosus", new = "Ranunculus montanus")
...
manual_translation <- data.frame(infoflora = character(), check_list = character())
manual_translation <- add_row(manual_translation, infoflora = "Alchemilla alpina aggr. s.l.", check_list = "Alchemilla alpina superaggr.")
manual_translation <- add_row(manual_translation, infoflora = "Peucedanum austriacum susp. austriacum", check_list = "Peucedanum austriacum (Jacq.) W. D. J. Koch subsp. austriacum")
manual_translation <- add_row(manual_translation, infoflora = "Scabiosa columbaria subsp. columbaria", check_list = "Scabiosa columbaria L. subsp. columbaria")
manual_translation <- add_row(manual_translation, infoflora = "Pulsatilla alpina", check_list = "Pulsatilla alpina (L.) Delarbre")
manual_translation <- add_row(manual_translation, infoflora = "Senecio ovatus", check_list = "Senecio ovatus (G. Gaertn. & al.) Willd.")
manual_translation <- add_row(manual_translation, infoflora = "Prunus padus subsp. padus", check_list = "Prunus padus L. subsp. padus")
manual_translation <- add_row(manual_translation, infoflora = "Sagina apetala subsp. apetala", check_list = "Sagina apetala Ard. subsp. apetala")
manual_translation <- add_row(manual_translation, infoflora = "Luzula luzuloides subsp. luzuloides", check_list = "Luzula luzuloides (Lam.) Dandy & Wilmott subsp. luzuloides")
manual_translation <- add_row(manual_translation, infoflora = "Scorzonera laciniata subsp. laciniata", check_list = "Scorzonera laciniata L. subsp. laciniata")
manual_translation <- add_row(manual_translation, infoflora = "Euphrasia rostkoviana subsp. rostkoviana", check_list = "Euphrasia rostkoviana Hayne subsp. rostkoviana")
manual_translation <- add_row(manual_translation, infoflora = "Veronica prostrata subsp. prostrata", check_list = "Veronica prostrata L. subsp. prostrata")
manual_translation <- add_row(manual_translation, infoflora = "Artemisia campestris", check_list = "Artemisia campestris L.")
manual_translation <- add_row(manual_translation, infoflora = "Hypochaeris uniflora aggr.", check_list = "Hypochaeris uniflora Vill.")

check_list_names <- rep(NA, length(unique_species))
for(i in 1:length(unique_species)){
  spec <- unique_species[i]
  if(spec %in% manual_translation$infoflora) {
    check_list_names[i] <- manual_translation$check_list[manual_translation$infoflora == spec]
  } else if(sum(startsWith(check_list$Taxonname, spec)) == 1) {
    check_list_names[i] <- check_list$Taxonname[startsWith(check_list$Taxonname, spec)]
  } else if(!endsWith(spec, " aggr.")) {
    if(sum((startsWith(check_list$Taxonname, spec) & !endsWith(check_list$Taxonname, " aggr."))) == 1) {
      check_list_names[i] <- check_list$Taxonname[startsWith(check_list$Taxonname, spec) & !endsWith(check_list$Taxonname, " aggr.")]
    } else if(!grepl(" subsp\\. ", spec) && sum((startsWith(check_list$Taxonname, spec) & !grepl(" subsp\\. ", check_list$Taxonname))) == 1) {
      check_list_names[i] <- check_list$Taxonname[startsWith(check_list$Taxonname, spec) & !grepl(" subsp\\. ", check_list$Taxonname)]
    }
  }
}

check_list$Taxonname[startsWith(check_list$Taxonname, "Amelanchier")]
sum(is.na(check_list_names))
unique_species[is.na(check_list_names) & !endsWith(unique_species, " spec.")]
unique_species[is.na(check_list_names) & endsWith(unique_species, " aggr.")]
```

```{r}
write_csv(data.frame(infoflora_taxon = unique_species, try_taxa = try_taxa, landolt_taxa = landolt_taxa, midolo_taxa = midolo_taxa, eive_taxa = eive_taxa, check_list = check_list_names), "../Daten/Intermediate/leuk_landolt_try_midolo_eive_taxon_conversion.csv")
```
