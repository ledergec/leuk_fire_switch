...
create_functional_group_plot <- function(data, title) {
  ...
  ggsave(paste("../Daten/Results/FunctionalGroups/mean_fraction_of_plants_in_each_functional_group_at", title, ".png"), plot = plot)
...
tmp$n_total_all_years <- tmp$n_total_goedicke + tmp$n_total_2004 + tmp$n_total_2005 + tmp$n_total_2006 + tmp$n_high_2006 + tmp$n_total_2007 + tmp$n_high_2013 + tmp$n_high_2023 + tmp$n_high_climax
...
View(tmp)
write_csv(tmp, "../Daten/Results/RedList/red_list_species_by_year_and_altitude.csv")
```
