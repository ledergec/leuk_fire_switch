...
complete_data <- left_join(data, red_list, join_by(`Species_unified_2004-23` == `Scientific name`))
complete_data <- complete_data[!is.na(complete_data$CAT),]
...
data_red_list <- distinct(complete_data, year, global_id, `Species_unified_2004-23`, altitude_band, CAT)
