...
within_diversity_low_plot <- create_within_plot_plot(elevations[1], elevations[2])
within_diversity_mid_plot <- create_within_plot_plot(elevations[2], elevations[3])
within_diversity_high_plot <- create_within_plot_plot(elevations[3], elevations[4] + 1)
