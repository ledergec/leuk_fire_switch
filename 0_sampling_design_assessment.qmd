...
rel <- brick("../Daten/QGIS/swiss-map-raster25-clipped.tif")
plotRGB(rel)
raster$color[raster$sampled] <- "red"
raster$color[raster$total] <- "blue"
raster$color[raster$on_patch] <- "black"
raster$color[raster$additional] <- "magenta"
raster$color[!raster$sampled & !raster$total & !raster$on_patch] <- ""
points(x = raster$x_coord[raster$sampled | raster$total | raster$on_patch], y = raster$y_coord[raster$sampled | raster$total | raster$on_patch], col = raster$color[raster$sampled | raster$total | raster$on_patch], type = "p" )
